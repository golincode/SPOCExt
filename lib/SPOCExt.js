...
/***/ function(module, exports, __webpack_require__) {
	...
	var Request = function () {
	    ...
	    _createClass(Request, null, [{
	        ...
	        key: 'post',
	        value: function post(url, data, isFile, progressFunction, self) {
	            return new _rsvp2.default.Promise(function (resolve, reject) {
	                if (!_utils2.default.Url.isSameDomain(url) && url.toLowerCase().indexOf('_api/web') > -1) {
	                    url = _utils2.default.Url.convertToXDomain(url);
	    ...
	    methods.upload = function (fileInput, expand, progressFunction, self) {
	        return new _rsvp2.default.Promise(function (resolve, reject) {
	            ...
	            reader.onloadend = function (e) {
	                ...
	                _utils2.default.Request.post(url, e.target.result, true, progressFunction, self).then(function (result) {
	                    resolve(result);
	                }, function (result) {
	                    reject(result);
	                });
